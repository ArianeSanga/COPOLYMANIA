...
void ComprarAlugar(Tabuleiro *tab, struct jogador *comprador, struct jogador *outroJogador, struct Propriedade *propriedade, int symbol)
{
    ...
    {
        printf("\nDeseja comprar a propriedade %s?\n", propriedade->nome);
        ...
        if (escolha == 1)
        {
            if (comprador->dinheiro >= propriedade->preco)
            {
                ...
                printf("\nParabens,Voce comprou a propriedade!\nSaldo Atual: %d\n", comprador->dinheiro);
    ...
    else
    {
        ...
        printf("\nSeu Saldo apos o pagamento:%d.\n", comprador->dinheiro);
        printf("\nSaldo de %s apos o pagamento:%d.\n", outroJogador->nome, outroJogador->dinheiro);
    }
}
...
void pegaCarta(struct jogador *jogador, PilhaCartas *cartas)
{
    ...
    if (popCarta(cartas, &elemento))
    {
        ...
        printf("|                                                           |\n");
        printf("|                                                           |\n");
        printf("|    voce caiu em uma posicao especial, pegue uma carta!    |\n");
        printf("|                                                           |\n");
        printf("|                                                           |\n");
        printf("-------------------------------------------------------------\n");
        printf("\n%s\n", elemento.descricao);
...
int main()
{
    ...
    struct Propriedade propriedades[] = {
        ...
        {35, "Avenida Bentivi", "Uma avenida moderna e conectada. Invista em tecnologia e esteja na vanguarda da revolucao digital.", " ", 450, 90},
        {36, " ", " ", " ", 0, 0},
        {37, "Avenida Ellen Pinheiro", "Uma avenida moderna e conectada. Invista em tecnologia e esteja na vanguarda da revolucao digital.", " ", 450, 90},
        {38, "N", " ", " ", 0, 0},
        {39, "Bulevar da Visao", "Um bulevar com uma visao clara para o sucesso. Invista e alcance novos patamares.", " ", 180, 36},
        {40, "Alameda da Prosperidade", "Uma alameda onde a prosperidade floresce. Desenvolva propriedades e cultive o sucesso.", " ", 280, 56}};
    ...
    printf("\nSeja Bem-vindo %s, voce eh o jogador 0\n\n", jogador1.nome);

    printf("Qual seu nome, Jogador?\n");
    scanf("%s", jogador2.nome);
    printf("\nSeja Bem-vindo %s, voce eh o jogador -1\n\n", jogador2.nome);
    ...
    do
    {
        ...
        if (jogador1.dinheiro <= 0)
        {
            ...
            printf("|                                                           |\n");
            printf("-------------------------------------------------------------\n");
            printf("\n%s nao seja tao ganancioso da proxima vez, talvez um curso de investimento seja uma boa!!!\n", jogador1.nome);
            break;
        }
        ...
        if (jogador2.dinheiro <= 0)
        {
            ...
            printf("|                                                           |\n");
            printf("-------------------------------------------------------------\n");
            printf("\n%s não seja tão ganancioso da proxima vez, talvez um curso de investimento seja uma boa!!!\n", jogador2.nome);
            break;
        }
